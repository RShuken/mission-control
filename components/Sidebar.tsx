...
const projects = [
  { name: "OpenClaw Install", href: "/projects/openclawinstall", color: "bg-purple-500" },
  { name: "Denver AI Training", href: "/projects/denveraitraining", color: "bg-blue-500" },
  { name: "MC Leads Worker", href: "/projects/mc-leads", color: "bg-green-500" },
  { name: "Mission Control", href: "/projects/mission-control", color: "bg-amber-500" },
];
  ...
  return (
    <>
      ...
      <div className="p-6 border-b border-[var(--border)]">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-accent-500 to-purple-600 flex items-center justify-center text-white font-bold">
            MC
          </div>
          <div>
            <h1 className="font-bold text-white">Mission Control</h1>
            <p className="text-xs text-[var(--muted)]">AI Work Dashboard</p>
          </div>
        </div>
      </div>
      ...
      <nav className="flex-1 p-4 space-y-1 overflow-y-auto">
        ...
        <div className="text-xs font-semibold text-[var(--muted)] uppercase tracking-wider mt-6 mb-3">
          Projects
        </div>
      ...
      <div className="p-4 border-t border-[var(--border)]">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-sm font-medium text-white">Molty</p>
            <p className="text-xs text-[var(--muted)]">AI Agent</p>
          </div>
        </div>
      </div>
    </aside>
